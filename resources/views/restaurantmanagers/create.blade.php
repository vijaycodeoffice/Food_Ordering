            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                            <li class="breadcrumb-item active">Create Restaurant Managers</li>
                                    </ol>
            </div>
...
<!-- end page title -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Create Restaurant Managers</h4>
        ...
        <form action="{{ route('restaurantmanagers.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
