        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="text-sm-end d-none d-sm-block">
                    Design & Develop by <a href="#!" class="text-decoration-underline">Agaati</a>
                </div>
            </div>
        </div>
    </div>
...
<script src="{{asset('assets/libs/node-waves.min.js')}}"></script>
<script src="{{asset('assets/libs/feather-icons.min.js')}}"></script>
<!-- pace js -->
<script src="{{asset('assets/libs/pace-js.min.js')}}"></script>
    <script src="{{asset('assets/libs/apexcharts.min.js')}}"></script>

    <!-- Plugins js-->
    <script src="{{asset('assets/libs/jquery-vectormap.min.js')}}"></script>
