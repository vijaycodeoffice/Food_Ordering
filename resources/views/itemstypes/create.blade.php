            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                            <li class="breadcrumb-item active">Create Item Types</li>
                                    </ol>
            </div>
...
<!-- end page title -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Create Item Types</h4>
        ...
        <div class="card-body">
        <form action="{{ route('itemstypes.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <input class="form-control" type="text" name="itemtypes_name" value="" id="itemtypes_name">
            </div>
               
            <div class="mb-3">
            <label for="itemtypes_description" class="form-label">Description</label>
            <input class="form-control" type="text" name="itemtypes_description" value="" id="itemtypes_description">
            </div>
