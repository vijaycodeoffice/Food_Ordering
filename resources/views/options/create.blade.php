...
<!-- end page title -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Create Options</h4>
        ...
        <form action="{{ route('options.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <input class="form-control" type="text" name="options_name" value="" id="options_name">
            </div>
           
            <div class="mb-3">
            <label for="options_description" class="form-label">Description</label>
            <input class="form-control" type="text" name="options_description" value="" id="options_description">
            </div>
