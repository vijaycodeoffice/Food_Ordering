            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                            <li class="breadcrumb-item active">Create Referral Points</li>
                                    </ol>
            </div>
...
<!-- end page title -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Create Referral Points</h4>
        ...
        <form action="{{ route('referralpoints.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <input class="form-control" type="text" name="refering_point" value="" id="refering_point">
            </div>
            ...
            <input class="form-control" type="text" name="refered_point" value="" id="refered_point">
            </div>
